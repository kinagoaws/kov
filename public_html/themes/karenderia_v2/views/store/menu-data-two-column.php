                                ...
                                <template v-if="items.total_addon <=0 && items.total_meta <=1 && items.price.length<=1 ">
                                    ...
                                    <template v-if=" items.qty>0 " >
                                        ...
                                        <div class="quantity-parent">
                                            ...
                                            <el-button @click.stop="updateInlineQtyBefore('less',items,val.cat_id)" color="#000000" class="white-color" circle>
                                               <i class="zmdi zmdi-minus font20"></i>
                                            </el-button>
                                            <div class="qty">{{ items.qty }}</div>                                            
                                            <el-button @click.stop="updateInlineQtyBefore('add',items,val.cat_id)" color="#000000" class="white-color" circle>
                                    ...
                                    <template v-else=" items<=0 " >  
                                        <?php if($disabled_inline_addtocart):?>
                                            <el-button @click="viewItemBefore({cat_id:val.cat_id,item_uuid:items.item_uuid})" color="#000000" class="white-color" circle>
                                              <i class="zmdi zmdi-plus font20"></i>
                                            </el-button>
                                        <?php else :?>                                                                                        
                                            <el-button @click="updateInlineQtyBefore('add',items,val.cat_id)"  color="#000000" class="white-color" circle>
                                               <i class="zmdi zmdi-plus font20"></i>
                                            </el-button>
                                        <?php endif;?> 
                                    </template>
                            ...
                            <template v-if="itemAvailable(items.item_id,val.cat_id)">
                                <template v-if="items.total_addon <=0 && items.total_meta <=1 && items.price.length<=1 ">
                                    ...
                                    <template v-else=" items<=0 " >  
                                        <?php if($disabled_inline_addtocart):?>
                                            <el-button @click="viewItemBefore({cat_id:val.cat_id,item_uuid:items.item_uuid})" color="#000000" class="white-color" circle>
                                               <i class="zmdi zmdi-more font20"></i>
                                            </el-button>
                                        <?php else :?>
                                            <el-button @click="updateInlineQtyBefore('add',items,val.cat_id)"  color="#000000" class="white-color" circle>
                                               <i class="zmdi zmdi-more font20"></i>
