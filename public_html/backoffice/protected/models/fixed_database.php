...
UPDATE st_payment_gateway SET attr4=".q('{"Webhooks Plan":"{site_url}/paypal/apiv2/webhooksplans","Events":"BILLING.SUBSCRIPTION.ACTIVATED, BILLING.SUBSCRIPTION.CREATED, BILLING.SUBSCRIPTION.CANCELLED, BILLING.SUBSCRIPTION.PAYMENT.FAILED"}')."
WHERE payment_code='paypal';   

UPDATE st_payment_gateway SET attr4=".q('{"Webhooks Plan":"{site_url}/razorpay/apiv2/webhooksplans","Events":"subscription.charged, subscription.updated, subscription.cancelled, subscription.pending, subscription.halted"}')."
