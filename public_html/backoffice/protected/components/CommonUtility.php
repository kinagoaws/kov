...
class CommonUtility
{
	...
	public static function formatDeliveryTimeRange($currentDate = '', $preparationTime='', $deliveryTime='', $timezone = 'America/New_York', $rangeBuffer = 5,$return_split=true)
    {
        ...
        $minTimeFormatted = $minTimeDate->format('g:i');
        $maxTimeFormatted = $maxTimeDate->format('g:i A');
