...
Class CPlan
{
	...
	public static function listing($lang = KMRS_DEFAULT_LANGUAGE , $exclude_free_trial=false , $customer_filter='')
	{
		$and = '';
	...
	public static function getPlanByID($package_id='',$lang=KMRS_DEFAULT_LANGUAGE)
	{
		$stmt = "
		SELECT a.package_id,
		a.package_uuid,
